# Offline Duplicate Image Scanner — Visual Matching for Photo Libraries
...
7. Apply cleanup or export report
...
**Library cleanup / folder scanning / export reports.**
...
```text
Project: AI Duplicate Photo Finder
